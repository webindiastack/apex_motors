export const INITIAL_VEHICLES = [
  ...
  },
  {
    ...
    exteriorColor: "Dual Tone Super White & Black Roof",
  ...
  },
  {
    ...
    drivetrain: "Front-Wheel Drive (FWD)",
    exteriorColor: "Celestial Silver Metallic / Black Roof",
  ...
  },
  {
    ...
    horsepower: "246 hp",
    drivetrain: "All-Wheel Drive (AWD)",
    exteriorColor: "Carpathian Grey Premium Metallic",
...
export const vehiclesData = INITIAL_VEHICLES;
...
// LocalStorage Persistence Helpers for Inventory
...
// LocalStorage Persistence Helpers for Inquiries
export function getStoredInquiries() {
  try {
    const saved = localStorage.getItem('apex_inquiries');
    if (saved) {
      return JSON.parse(saved);
    }
  } catch (e) {
